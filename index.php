  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="span4">
          <h2>Kos Laki - Laki</h2>
          <p>Berisi Daftar Kos Laki - Laki yang ada di sekitar Udinus</p>
          <p><a class="btn" href="daftar.php?kos=lk">Lihat Daftar Kos &raquo;</a></p>
        </div>
        <div class="span4">
          <h2>Kos Perempuan</h2>
          <p>Berisi Daftar Kos Perempuan yang ada di sekitar Udinus</p>
		  <p><a class="btn" href="daftar.php?kos=pr">Lihat Daftar Kos &raquo;</a></p>
       </div>
      </div>
